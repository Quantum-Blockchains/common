...
import { mldsa44Verify as wasmVerify/*, isReady*/ } from '@polkadot/wasm-crypto';
 ...
 *
 * mldsa44Verify([...], [...], [...]); // => true/false
 * ```
 */
export function mldsa44Verify (message: HexString | Uint8Array | string, signature: HexString | Uint8Array | string, publicKey: HexString | Uint8Array | string): boolean {
